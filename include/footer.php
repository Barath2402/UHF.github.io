<footer class="full-row bg-secondary p-0">
            <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        ...
                                        <p class="pb-20 text-white">United Hands Foundation (UHF ) is a public charitable Trust registered under the Indian Trust Act 1882 on Augest, 2020 with the registration number 44/2020, allowing the entity to receive foreign funds. Income Tax Act 80 (g) has applied for donations under the Income Tax Act to this Trust.</p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>No.94/2 2nd floor, Sathyam towers, Gandhiji street, Opp. Carmel school, Karur bypass road, Kollampalayam, Erode - 638002.
</li>
													<li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+91 96297 01732</li>
                                                    <li class="hover-text-primary"><i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>uhf@realestatest.com</li>
                                                </ul>
                                            </div>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© <?php echo date('Y');?>© 2024 UHF. All rights reserved |</span> </div>
                    <div class="col-sm-6">
