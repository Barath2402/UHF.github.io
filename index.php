                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Looking to sell your property? Our expert team is here to help you navigate the process with ease. From pricing strategies to marketing plans, we'll work closely with you to showcase your property in the best light and secure the best possible deal.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Searching for the ideal rental property? Let us assist you in finding the perfect place to call home. Whether you're looking for a cozy apartment, a spacious house, or a commercial space, we have a wide range of rental options to suit your needs and preferences.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Ready to list your property? Trust our comprehensive property listing service to connect you with potential buyers or renters quickly and efficiently. With our strategic marketing approach and extensive network, we'll ensure maximum exposure for your property, helping you achieve your real estate goals.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Investing in real estate can be complex, but with our legal investment services, you can invest with confidence. Our team of legal experts will provide valuable guidance and assistance throughout the investment process, ensuring compliance with all legal requirements and maximizing your returns. Whether you're a seasoned investor or new to the game, we're here to help you make informed decisions and achieve your financial objectives.
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Our reputation speaks for itself. With top ratings and glowing testimonials from satisfied clients, we're proud to be recognized as a leader in the real estate industry. Trust us to deliver exceptional service and results that exceed your expectations.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Experience the difference with our commitment to quality. From our personalized approach to our attention to detail, we prioritize excellence in everything we do. Whether you're buying, selling, or renting, you can count on us for a smooth and successful real estate experience.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Our team of experienced agents is here to guide you every step of the way. With in-depth knowledge of the local market and years of industry expertise, we're equipped to handle any real estate challenge with confidence and professionalism. Rest assured, you're in good hands with our dedicated team by your side.</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Engage in meaningful conversations and stay informed about the latest trends, market insights, and real estate news. Join our community discussions to exchange ideas, share experiences, and learn from fellow homeowners, investors, and industry experts. Whether you're seeking advice on property management, investment strategies, or home improvement tips, our discussion platform is the perfect place to connect with like-minded individuals and expand your knowledge.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Explore essential documents and resources related to your real estate transactions. Our comprehensive file review section provides access to important files, including contracts, agreements, inspection reports, and property disclosures. Review these documents at your convenience to ensure transparency and clarity throughout the buying, selling, or renting process. With easy access to all the information you need, you can make informed decisions and proceed with confidence.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Take the next step towards acquiring your dream property. Whether you're in the market for a new home, an investment property, or a commercial space, our acquisition services are designed to simplify the process and maximize your success. From property search and evaluation to negotiation and closing, our team of experts is dedicated to helping you find the perfect property and secure a favorable deal. With our guidance and support, acquiring real estate has never been easier.</p>
                        </div>
                    </div>
                </div>
            </div>
